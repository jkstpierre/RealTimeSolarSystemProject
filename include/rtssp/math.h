 ...
 * @return highp_vec3 
 */
extern highp_vec3 addHighPrecisionVectors(highp_vec3 v1, highp_vec3 v2);
 ...
 * @return highp_vec3 
 */
extern highp_vec3 subtractHighPrecisionVectors(highp_vec3 v1, highp_vec3 v2);
 ...
 * @return highp_vec3 
 */
extern highp_vec3 scaleHighPrecisionVector(highp_vec3 v, double scale);
 ...
 */
extern void convertHighPrecisionVector(const highp_vec3 *src, vec3 dest, float scale_factor);
